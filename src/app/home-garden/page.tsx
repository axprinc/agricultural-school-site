        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white text-gray-800 p-8 rounded-xl shadow-2xl mb-8">
            ...
            <div className="bg-gradient-to-r from-harvest-orange-50 to-farm-green-50 rounded-xl p-6 mb-8">
              <h3 className="text-xl font-bold text-gray-800 mb-4 text-center">料金</h3>
          ...
          <div className="bg-red-600 text-white p-6 rounded-xl mb-8">
            <h3 className="text-xl font-bold mb-2">⚠️ 期間限定のご案内です</h3>
            <p>内容・価格は予告なく変更・終了となる場合があります。お早めにお申し込みください。</p>
          </div>

          {/* 入会までのステップ */}
          <div className="bg-white text-gray-800 p-8 rounded-xl shadow-2xl mb-8 text-left">
            <h3 className="text-2xl font-bold text-farm-green-800 mb-4">入会までの4つのステップ</h3>
