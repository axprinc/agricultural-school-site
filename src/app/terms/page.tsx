          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-farm-green-100 p-8 md:p-12">
            <div className="space-y-8 text-gray-700 leading-relaxed">
              <div className="border-b border-farm-green-200 pb-6">
                ...
                <p className="mb-4">
                  本規約（以下「本規約」といいます。）は、「グリーンハーベスト・ベルジュ農業スクール」（以下「本サービス」といいます。）の利用に関して、基本的事項および会員が遵守すべき内容を定めるものです。会員は、本規約に同意のうえ、本サービスを利用するものとします。
                </p>
                <p className="mb-4">
                  本サービスは、<strong>グリーンハーベスト・ベルジュ株式会社（以下「運営事務局」といいます。）</strong>が運営・管理を行います。会員は、本サービスの利用に際して、随時提供される情報や注意事項を確認する責任を負います。サービス利用をもって、本規約に同意したものとみなされます。
                </p>
                <p>
