      ...
      <main>
              ...
              <div>
                <FadeInSection>
                  <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight leading-none text-gray-900 mb-6">
                    ...
                    <span className="block">ライフスタイル・ウォーター</span>
                  </h1>
                </FadeInSection>
        ...
        <section className="py-24 bg-[#FAFAFA]">
          <div className={`mx-auto px-8 ${MAX_WIDTH_CLASS}`}>
            <FadeInSection className="text-center mb-12">
              <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight mb-4">
                醗酵が育てる、肌の小さな生態系 ― 皮膚常在菌との共生という美しさ
              </h2>
            </FadeInSection>
            ...
            <FadeInSection>
              <div className="bg-white rounded-3xl p-10 shadow-lg space-y-6 text-gray-700 leading-relaxed">
                ...
                <p>そこで私たちが注目したのが、醗酵です。</p>

                <div className="my-8 h-px bg-gray-200" />

                <h3 className="text-2xl font-bold text-gray-900">醗酵は“菌がつくる、菌のための恵み”</h3>
                <p>醗酵とは、微生物が素材を分解し、変化させ、新しい価値を生みだす生命の働き。乳酸菌、酵母、麹菌。彼らがつくり出すアミノ酸、ペプチド、糖類、ビタミンは、肌の常在菌にとって理想的な栄養源になります。</p>
                <p>醗酵の力で生まれた成分は、常在菌が育つ“土壌”を整え、肌の上に健全でしなやかな生態系を作り出します。それはまるで、小さな菌たちに向けた「ごちそう」のように。醗酵は、肌を外側から飾るのではなく、内側で働く菌たちを活かす美容なのです。</p>

                <div className="my-8 h-px bg-gray-200" />

                <h3 className="text-2xl font-bold text-gray-900">醗酵 × 常在菌＝肌が自ら整う力</h3>
                <p>醗酵エキスが常在菌環境を豊かにすると、肌は本来の力を取り戻しはじめます。</p>
                ...
                <p>これは化粧品が肌を“変える”のではなく、肌自身が、自らを整えていくという現象。醗酵が、あなたの肌に宿る菌たちの力を引き出し、肌の自然な美しさが息を吹き返すのです。</p>

                <div className="my-8 h-px bg-gray-200" />

                <h3 className="text-2xl font-bold text-gray-900">醗酵が未来の美容にもたらすもの</h3>
                <p>私たちは、肌と常在菌と醗酵を「ひとつの生態系」として捉えています。人の手ではつくれない豊かな栄養を生み、肌を守る菌たちを整え、その結果として肌が美しくなる。この循環こそが、自然と寄り添い、肌自身を尊重する新しいスキンケアの形だと考えています。</p>

                <p className="text-center font-semibold text-gray-900 mt-8">― 醗酵がつくる美しさは、 肌と菌が生きていることへの讃歌です。 ―</p>
              </div>
            </FadeInSection>
          </div>
        </section>
