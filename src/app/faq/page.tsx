...
export default function FAQ() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer: "はい、野菜にはそれぞれ適した栽培時期があります。当スクールでは、季節に合わせてその時期に最適な野菜の育て方をご指導いたします。春夏秋冬、それぞれの季節で楽しめる野菜栽培を学べます。"
    },
    {
      question: "スクールの開催時間は？",
      answer:
    ...
    },
    {
      ...
      answer: "現在のお支払い方法はクレジットカード決済のみとなります。今後、他のお支払い方法にも対応できるよう検討してまいります。"
    },
    {
      question: "駐車場はありますか？",
      answer:
    ...
    {
      question: "Nパワープラス®とは何ですか？",
      answer:
        "Nパワープラス®は、土に新しい菌を足すのではなく、もともとその土地にいる微生物たちにバランスよく栄養を与えて元気にする「微生物のための栄養剤」です。長年の化学肥料や農薬で疲れた土を、本来の自然な状態（山の腐葉土のような豊かな土）に近づけることを目指した、土壌環境づくりのための資材です。"
    },
    {
      question: "Nパワープラス®を使うとどんな効果が期待できますか？",
      answer:
        "土が柔らかくなり、根がしっかりと張ることで、収穫量アップや味の濃さ・香りの良さが期待できます。また、土の環境が整うことで害虫が寄りにくくなり、農薬や化学肥料の使用量を減らしやすくなります。実際に、台風後も倒れにくくなったり、収穫物の鮮度が長持ちしたというお声もいただいています。"
    },
    {
      question: "Nパワープラス®の原材料や安全性について教えてください。",
      answer:
        "主な原材料は大豆・米ぬか・糖蜜などの天然由来成分で、化学合成物質は使用していません。微生物のエサとなる成分で構成されており、お子様やペットのいるご家庭でも安心してお使いいただける設計です。なお、肥料取締法上は「たい肥」として届け出されており、窒素・リン酸・カリはいずれも0.5％未満です。"
    },
    {
      question: "Nパワープラス®の飲用や類似品について注意点はありますか？",
      answer:
        "Nパワープラス®は、あくまで肥料・土壌改良材であり飲料ではありません。飲用による健康効果や効能は一切なく、万が一飲用された場合の健康被害についても当社では責任を負いかねます。また、ネット上には類似品・模倣品も流通しているため、必ず正規の販売ルートから本物の商品をご購入ください。"
    },
    {
      question: "Nパワーの成分が入ったライフスタイル・ウォーターはありますか？",
      answer:
        "はい、ございます！Nパワーは土壌用のお水でございますのでNパワーとは少し異なりますが、表皮常在菌が育ちやすくなるように設計したオリジナルのライフスタイル・ウォーターをご用意しております。自然の力を、最も純粋な形で肌に届けるスキンケア製品です。詳しくは製品ページをご覧ください。",
      links: [
        { href: "/naturalpure-lp", text: "ライフスタイル・ウォーターの詳細を見る" }
      ]
    }
  ]
